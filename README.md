...
- 표지 카드 미리보기 및 배경색 직접 선택 (책 표지 평균 RGB 기반 색상 그리드)
- Canvas API로 Instagram 권장 해상도 이미지 생성 및 다운로드
- 인스타그램 자동 업로드 (예정)
...
│   │   │   └── CoverCardPreview.tsx  # 표지 카드 미리보기 & 다운로드
│   │   └── lib/
